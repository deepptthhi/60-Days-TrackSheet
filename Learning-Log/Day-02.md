...
I also started learning the basics of Data Structures and Algorithms. Before today, I thought DSA was mainly about solving coding questions. Now I understand that it's actually about learning different ways to solve the same problem and choosing the better solution.
...
Git became much clearer to me today.

Earlier, I thought Git and GitHub were almost the same thing. Now I understand that Git is the tool that tracks changes made to my projects, while GitHub is where those projects can be stored and shared.

Creating my first `.gitignore` file also helped me understand that not every file should be tracked by Git.
